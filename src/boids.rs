...
pub fn calculate_boid_steering(
    ...
    for mut ff in q_ff.iter_mut() {
        ...
        for (ent, pos, boid) in &relevant_boids {
            ...
            // Flowfield direction
            let cell = ff.get_cell_from_world_position(my_pos.translation);
        ...
        for (ent, pos, boid) in &relevant_boids {
            ...
            // Flowfield direction
            let cell = ff
                .destination_flowfield
                .get_cell_from_world_position(my_pos.translation);
            let ff_dir_2d = cell.best_direction.vector();
